...
local function nvim_tree_on_attach(bufnr)
  ...
  -- Remove default buffer-edit mappings in the tree
  ...
  vim.keymap.set('n', 'P', get_node_under_cursor, opts('Print Node Path'))

  -- Default Keybindings that have been replaced
...
-- Setup Nvim-Tree with our custom settings
